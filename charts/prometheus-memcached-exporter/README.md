...
- OCI Artifact: `oci://ghcr.io/prometheus-community/charts/prometheus-memcached-exporter`
- Helm Repository: `https://prometheus-community.github.io/helm-charts` with chart `prometheus-memcached-exporter`
...
```console
helm install [RELEASE_NAME] oci://ghcr.io/prometheus-community/charts/prometheus-memcached-exporter
```
...
```console
helm show values oci://ghcr.io/prometheus-community/charts/prometheus-memcached-exporter
```
