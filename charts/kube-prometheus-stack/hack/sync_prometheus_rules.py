...
refs = {
    ...
    'ref.kube-prometheus': '6828741a34a392e58d28e484364234fe191da65c',
    ...
    'ref.etcd': 'ef0606044a042e8c82d306ad4215bf42e7dcded8',
}
...
replacement_map = {
    ...
    'job="{{ $kubeletJob }}"': {
        'replacement': 'job="{{ $kubeletJob }}", namespace{{ $namespaceOperator }}"{{ $targetNamespace }}"',
