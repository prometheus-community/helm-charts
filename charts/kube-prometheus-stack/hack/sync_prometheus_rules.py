...
condition_map = {
    ...
    'k8s.rules.container_memory_swap.rules': ' .Values.defaultRules.rules.k8sContainerMemorySwap',
    'k8s.rules.container_memory_working_set_bytes.rules': ' .Values.defaultRules.rules.k8sContainerMemoryWorkingSetBytes',
    'k8s.rules.container_resource.rules': ' .Values.defaultRules.rules.k8sContainerResource',
    'k8s.rules.pod_owner.rules': ' .Values.defaultRules.rules.k8sPodOwner',
